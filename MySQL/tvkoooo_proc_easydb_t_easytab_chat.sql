...
/* Procedure structure for procedure `p_chat_easydb_t_easytab` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_chat_easydb_t_easytab` */;

DELIMITER $$

/*!50003 CREATE  PROCEDURE `p_chat_easydb_t_easytab`(
