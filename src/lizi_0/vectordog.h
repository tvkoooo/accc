...
typedef void (*fun__vectordog) (void);
...
//tool init  数据赋值
extern void fun__vectordog_new_add(struct fun__vectordog_new* head,fun__vectordog fdog);
...
//tool init  数据清零
extern void fun__vectordog_new_clear(struct fun__vectordog_new* ptalk,struct fun__vectordog_nam* pname);

//tool destroy 数据回初始化
extern void fun__vectordog_new_destroy(struct fun__vectordog_new* ptalk,struct fun__vectordog_nam* pname);
