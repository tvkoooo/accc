...
set protoc_p=../../../../../mm/mm_lib/build/protobuf/proj_%platform%/bin/Release
set protoc_n_exe=../../../../../mm/mm_lib/build/protobuf/proj_%platform%/bin/Release/protoc
...
call :build_proto c_dialogue_com
call :build_proto c_dialogue_baseinfo
pause
GOTO :EOF
