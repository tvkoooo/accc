...
//                 break;
            ...
            case 'anchor_sunshine_level_up_rq':
                ...
                break;
            case 'on_test_multicast_packet':
                $result = test_api::on_test_multicast_packet($params);
                break;
            ...
            case 'linkcall_list_user_rq'://连麦:用户（主播/用户）查询当前最新连麦信息
                ...
                break;
			case 'PQueryDiceSystemGold'://查询主播当前开筛子是否添加系统金币
				$result = GameApi::QueryDiceSystemGold($params);
                break;
            case 'linkcallpk_singer_open_function_rq'://连麦pk:主播打开连麦pk功能
                $result = linkcall_pk_api::on_linkcallpk_singer_open_function_rq($params);
                break;
            case 'linkcallpk_singer_seek_online_list_rq'://连麦pk:主播查询当前在线满足条件主播申请列表
                $result = linkcall_pk_api::on_linkcallpk_singer_seek_online_list_rq($params);
                break;
            case 'linkcallpk_apply_rq'://连麦pk:主播客场申请连线
                $result = linkcall_pk_api::on_linkcallpk_apply_rq($params);
                break;
            case 'linkcallpk_link_rq'://连麦pk:主播主场连线pk
                $result = linkcall_pk_api::on_linkcallpk_link_rq($params);
                break;
            case 'linkcallpk_confirm_rq'://连麦pk:主播客场确认pk功能
                $result = linkcall_pk_api::on_linkcallpk_confirm_rq($params);
                break;
            case 'linkcallpk_start_rq'://连麦pk:主场主播启动连麦pk
                $result = linkcall_pk_api::on_linkcallpk_start_rq($params);
                break;
            case 'linkcallpk_count_rq'://连麦pk:主播结算pk
                $result = linkcall_pk_api::on_linkcallpk_count_rq($params);
                break;
            case 'linkcallpk_addtime_rq'://连麦pk:主播延长连麦pk
                $result = linkcall_pk_api::on_linkcallpk_addtime_rq($params);
                break;
            case 'linkcallpk_close_rq'://连麦pk:主播结束连麦pk
                $result = linkcall_pk_api::on_linkcallpk_close_rq($params);
                break;
            case 'linkcallpk_user_seek_pk_rq'://连麦pk:用户查询连麦pk主播信息
                $result = linkcall_pk_api::on_linkcallpk_user_seek_pk_rq($params);
                break;
            case 'linkcallpk_user_seek_gift_rq'://连麦pk:用户查询连麦pk用户送礼信息
                $result = linkcall_pk_api::on_linkcallpk_user_seek_gift_rq($params);
                break;
            case 'linkcallpk_singer_seek_link_list_rq'://连麦pk:主播查询客场其他主播给自己的连麦pk列表申请的请求列表
                $result = linkcall_pk_api::on_linkcallpk_singer_seek_link_list_rq($params);
                break;
            case 'linkcallpk_user_comein_room_rq'://连麦pk:用户进入房间
                $result = linkcall_pk_api::on_linkcallpk_user_comein_room_rq($params);
                break;
            case 'linkcallpk_singer_comein_room_rq'://连麦pk:主播进入直播房间
                $result = linkcall_pk_api::on_linkcallpk_singer_comein_room_rq($params);
                break;
            case 'linkcallpk_pking_switch_scene_rq'://连麦pk:主场切换场景视角
                $result = linkcall_pk_api::on_linkcallpk_pking_switch_scene_rq($params);
                break;
                
            case 'linkcallpk_singer_leave_event'://连麦pk:测试主播离场
                $result = linkcall_pk_api::on_linkcallpk_singer_leave_event($params);
                break;
